<template>
            ...
            <div class="container-event">
                ...
                <div class="container-event-main d-flex justify-content-center justify-content-md-start flex-wrap">
                    ...
                    <div class="container-event-info d-flex flex-column  justify-content-center">
                        ...
                        <h4 class="event-organizer">{{ event.orgName }}</h4>
                        <div class="container-event-tags d-flex align-items-center flex-wrap">

                            <span class="event-tag" v-for="tag, index in event.tags" :key="tag"> #{{ tag.replace(' ',
            '') }} </span>

                        </div>
                        <div class="container-event-participate d-flex flex-wrap">

                            <button class="button-view main-button">Принять</button>
                            <button class="button-view secondary-button">Отклонить</button>
                        </div>
                    </div>
    ...
    <section class="event-info-section" id="info">
        ...
        <div class="container-block">
            <div
                class="container-about d-flex align-items-center justify-content-center justify-content-lg-between flex-wrap">
                <div class="container-info" v-if="event.status != 'Завершено'">
                    <h3 class="block-title text-center">Даты проведения</h3>

                    <div
                        class="container-info-items d-flex flex-column align-items-center justify-content-center justify-content-md-between">
                ...
                <div class="container-winner" v-if="event.status == 'Завершено'">
                    ...
                    <div
                        class="container-info-items d-flex flex-column align-items-center justify-content-center justify-content-lg-between">
                        <div class="container-info-item">
        ...
        <div class="container-block">
            <div class="container-description">
                ...
                <div class="container-description-text text-center">
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident porro velit iure saepe magnam
                        soluta corrupti eum, accusantium aliquid! Quasi quisquam quidem amet placeat perspiciatis
                        voluptatum et dolorem unde nulla nobis incidunt facilis, ut eius fuga nostrum. Eos perferendis
                        iste aliquam corporis sunt laborum maiores nisi harum. Esse asperiores at veniam ex voluptate?
                        Quod eveniet itaque, quae est velit eum totam sapiente voluptates debitis iste ipsum
                        perspiciatis, quasi saepe, fugit beatae illum neque pariatur? Nulla, dolor cupiditate expedita
                        porro assumenda praesentium sint tempore minima distinctio rerum harum asperiores et? Eligendi
                        sed dolore repellat! Ratione nulla aspernatur architecto laborum excepturi quaerat rerum
                        reprehenderit totam neque, in necessitatibus maxime beatae, saepe consectetur vitae nihil,
                        tenetur fugit corrupti? Consequuntur culpa dolorum voluptatem. Iste alias quisquam nobis porro
                        ab sint ea, explicabo asperiores reprehenderit ullam, beatae nihil architecto nam magnam
                        voluptas assumenda, dicta accusamus temporibus? Saepe, iure autem voluptatum nemo perspiciatis,
                        laudantium quasi earum dolorem cum tempora sit nobis dignissimos id sequi eum, harum libero
                        blanditiis optio? Earum saepe quis iure consequuntur asperiores provident, est corrupti
                        perspiciatis exercitationem explicabo voluptate assumenda pariatur! Nostrum, saepe itaque. Ab
                        recusandae nesciunt odio suscipit labore sequi nam quas, ducimus adipisci distinctio perferendis
                        fugit laboriosam iste sit in dolorem?
                    </p>
                </div>
                <div class="container-event-participate d-flex justify-content-center">
                    <a class="button-view main-button text-uppercase" download href="">Скачать файл с заданием</a>
                </div>
            </div>
        </div>
    </section>
