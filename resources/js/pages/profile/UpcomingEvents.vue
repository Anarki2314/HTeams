        ...
        <div class="container-block">
            <div class="container-events">
                ...
                <div class="container-events-title d-flex align-items-center justify-content-between">
                    <h3 class="block-title text-center text-lg-start">Предстоящие соревнования</h3>
...
export default {
    ...
    methods: {
        ...
        async getEvents() {
            ...
            try {
                const response = await api.get('/events/upcoming?page=' + this.page + '&' + new URLSearchParams(this.query).toString());
        ...
        async loadNextPage() {
            ...
            try {
                const response = await api.get('/events/upcoming?page=' + this.nextPage + '&' + new URLSearchParams(this.query).toString());
                this.nextPage = (response.data.next_page_url) ? response.data.next_page_url.split('page=')[1] : null;
